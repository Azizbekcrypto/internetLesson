...
const QZ_BG_SHAPES = [
  { ch: 'KIM',    l: 5,  t: 16, s: 30, c: 'rgba(15,166,214,0.09)', d: 19, dl: 0 },
  { ch: 'MUAMMO', l: 82, t: 12, s: 26, c: 'rgba(255,79,40,0.08)',  d: 23, dl: 1.5 },
  { ch: 'YECHIM', l: 9,  t: 74, s: 26, c: 'rgba(34,160,92,0.09)',  d: 27, dl: 0.8 },
  { ch: '🎯',     l: 78, t: 70, s: 30, c: 'rgba(20,17,14,0.05)',   d: 21, dl: 2.2 },
  { ch: '💡',     l: 46, t: 86, s: 30, c: 'rgba(20,17,14,0.05)',   d: 25, dl: 1.1 },
  { ch: 'KIM?',   l: 66, t: 24, s: 24, c: 'rgba(15,166,214,0.09)', d: 17, dl: 0.4 },
  { ch: 'nega?',  l: 24, t: 34, s: 22, c: 'rgba(20,17,14,0.05)',   d: 20, dl: 1.9 },
  { ch: '👤',     l: 90, t: 46, s: 24, c: 'rgba(20,17,14,0.05)',   d: 24, dl: 1.3 },
  { ch: '+',      l: 2,  t: 46, s: 26, c: 'rgba(245,166,35,0.10)', d: 26, dl: 2.6 },
];
...
function QzFX() {
  ...
  useEffect(() => {
    ...
    const draw = (tm) => {
      ...
      for (const t of toks) { t.x += t.vx * DPR; t.y -= (.08 + t.z * .12) * DPR; if (t.y < -34) t.y = H + 34; if (t.x < -50) t.x = W + 50; if (t.x > W + 50) t.x = -50; ctx.save(); ctx.translate(t.x, t.y); ctx.rotate(t.r * .12); ctx.font = '700 ' + ((12 + t.z * 18) * DPR) + 'px "JetBrains Mono",monospace'; ctx.fillStyle = 'rgba(20,17,14,' + (.03 + t.z * .05) + ')'; ctx.textAlign = 'center'; ctx.fillText(t.t, 0, 0); ctx.restore(); }
