...
const LESSON_META = { lessonId: 'js-cond-01-v17', lessonTitle: { uz: 'JavaScript — if/else', ru: 'JavaScript — if/else' } };
const SCREEN_META = [
...
const RECAPS = {
  ...
  4: {
    ...
    cards: [
      {
        ic: "🚦",
        h: "if — bu shart eshigi",
        body: <>if — bu <b>eshik oldidagi qorovul</b>. U shartni tekshiradi: agar shart <b>rost (true)</b> bo'lsa — eshikni ochadi va ichidagi kod ishlaydi. Rost bo'lmasa — o'tkazmaydi.</>,
    ...
    cards: [
      {
        ...
        body: <>if va else — bu <b>yo'l ayrilishi</b>. Shart rost bo'lsa — <b>if</b> yo'lidan yurasan. Rost bo'lmasa (false) — <b>else</b> yo'lidan yurasan. Ikkalasi bir vaqtda emas.</>,
  ...
  10: {
    ...
    cards: [
      ...
      },
      {
        ic: "📥",
        h: "= esa qiymat SOLADI",
        body: <>Bitta teng <b>=</b> — bu tekshirish emas, <b>qutiga qiymat solish</b>: <b>ball = 100</b> degani «ball qutisiga 100 ni joyla». Tekshirmoqchi bo'lsang har doim === ishlat, aks holda xatoga tushasan.</>,
        vis: <RcFlow items={["= soladi", "=== tekshiradi"]} sep="·" />
      },
      {
        ic: "🧩",
        h: "Boshqa belgilar boshqa ish",
        body: <>+ belgisi <b>qo'shadi</b>, =&gt; esa strelka (funksiya) uchun. Tenglikni tekshirishga faqat <b>===</b> yaraydi. Shartda «tengmi?» so'ramoqchi bo'lsang — <b>===</b> yoz.</>
      }
    ]
  },
    ...
    cards: [
      {
        ic: "🪆",
        h: "if ichida yana if",
        body: <>Bitta if ichiga <b>yana bir if</b> qo'ysang — bu <b>ichma-ich (nested) shart</b> deyiladi. Xuddi <b>matryoshka</b> qo'g'irchog'idek: kattasini ochsang, ichidan kichigi chiqadi.</>,
        vis: <RcFlow items={["tashqi if", "ichida", "yana if"]} />,
        ask: "Matryoshkaning ichidagisiga yetish uchun avval nimani ochasan?"
      },
      {
        ic: "🚪",
...
const QUIZ_BANK = [
  { q: "if (yosh >= 12) — yosh 10 bo'lsa, ichidagi kod ishlaydimi?", opts: ["Ha, ishlaydi", "Yo'q — shart false", "Xato beradi", "Ba'zan"], correct: 1 },
  { q: "14 > 12 ifodasi qanday qiymat qaytaradi?", opts: ["14", "true", "false", "12"], correct: 1 },
  { q: "= va === o'rtasidagi farq nima?", opts: ["Farqi yo'q", "= qiymat soladi, === tenglikni tekshiradi", "= tekshiradi, === soladi", "=== faqat raqamlar uchun"], correct: 1 },
  { q: "if bloki ishlamasa, o'rniga qaysi blok ishlaydi?", opts: ["Yana if", "else bloki", "Hech biri", "Sikl"], correct: 1 },
  ...
  { q: "Bir nechta shartni ketma-ket tekshirish uchun nima ishlatiladi?", opts: ["else", "else if", "nested var", "=== ketma-ket"], correct: 1 },
  { q: "if ichida yana if yozish nima deb ataladi?", opts: ["Sikl", "Ichma-ich (nested) shart", "else if", "Funksiya"], correct: 1 },
  { q: "if (ball >= 90) da ball = 90 bo'lsa, shart true bo'ladimi?", opts: ["Yo'q, faqat 91+ da", "Ha — >= tenglikni ham qamraydi", "Xato beradi", "Faqat ball=100 da"], correct: 1 },
  { q: "5 <= 3 ifodasi nima qaytaradi?", opts: ["true", "false", "5", "3"], correct: 1 },
  { q: "if/else da bir vaqtda nechta blok ishlaydi?", opts: ["Ikkalasi ham", "Faqat bittasi", "Hech biri", "Uchtasi"], correct: 1 },
