...
const LESSON_META = { lessonId: 'pm-structure-02-v17', lessonTitle: { uz: 'Struktura — UX qaror', ru: 'Структура как UX-решение' } };
const SCREEN_META = [
...
const QUIZ_BANK = [
  { q: "Sayt strukturasi (bo'limlar tartibi) aslida nima?", opts: ["Shunchaki bezak", "UX qaror — foydalanuvchi qulayligi uchun", "Faqat dizaynerning didi", "Tasodifiy tanlov"], correct: 1 },
  ...
  { q: "'Isbot' bo'limi nima uchun kerak?", opts: ["Sahifani uzaytirish", "Ishonch uyg'otish", "Rang qo'shish", "Tugmani yashirish"], correct: 1 },
  { q: "Yaxshi tuzilgan sahifa nimaga o'xshaydi?", opts: ["Tartibsiz ro'yxatga", "Hikoyaga — qadam-baqadam yetaklaydi", "Lug'atga", "Bo'sh varaqqa"], correct: 1 },
  { q: "Bo'limlar tartibi nega muhim?", opts: ["Chiroyli ko'rinish", "Foydalanuvchini muammodan yechimga olib boradi", "Sahifa uzunroq", "Farqi yo'q"], correct: 1 },
  { q: "Bo'limlar aralash tartibda bo'lsa nima bo'ladi?", opts: ["Yaxshiroq", "Foydalanuvchi chalkashadi va ketadi", "Hech narsa", "Tezroq yuklanadi"], correct: 1 },
  { q: "'Muammo' bo'limi qanday his uyg'otishi kerak?", opts: ["'Bu menga tanish'", "'Qiziq emas'", "'Juda qimmat'", "'Murakkab'"], correct: 0 },
  { q: "Chiroyli va ishonchli sayt farqi ko'pincha nimada?", opts: ["Ranglarida", "Tartibida (strukturasida)", "Shrift o'lchamida", "Rasmlar sonida"], correct: 1 },
  { q: "YouTube kabi saytlar qanday mantiqqa amal qiladi?", opts: ["Avval harakat, keyin sarlavha", "Avval eng muhimi, oxirida harakat", "Tasodifiy tartib", "Faqat matn"], correct: 1 },
];
